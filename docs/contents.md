...
| Name          | Description                                                                                                                                                                                                                                        |
|:--------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SLA Templates | SLA Templates in FortiSOAR help create an in-built SLA management for cases and alerts. For more information, please refer to [SLA Management](https://docs.fortinet.com/document/fortisoar/7.5.0/administration-guide/792686/sla-management). |
